      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-100 px-4">
        <div className="container mx-auto max-w-md rounded-[36px] bg-white px-10 py-12 shadow-xl">
          <div className="text-center">
            ...
            >
              Welcome <span style={{ color: "#2B7FFF" }}>Back</span>
            </h1>
          ...
          <p className="text-center">You Have already account <Link className="text-blue-500" href={'/register'}>Register Now</Link></p>
        </div>
      </div>
    </div>
  );
